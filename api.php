...
elseif(strpos($result2, "succeeded")) {
    ...
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result:CHARGED '.$amt.' ✅  Checker By: @TG_StinxBid </span><br>';
exit;
}

elseif(strpos($result2, "Your card has insufficient funds.")) {

    echo 'LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: INSUFFICIENT FUNDS ✅  Checker By: @TG_StinxBid </span><br>';
    exit;
    }
...
elseif(strpos($result2, "incorrect_zip")) {
    ...
    echo 'LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: CVV LIVE ✅  Checker By: @TG_StinxBid </span><br>';
    exit;
    }
...
elseif(strpos($result2, 'security code is incorrect.')) {
    ...
    echo 'LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: CCN LIVE ✅  Checker By: @TG_StinxBid </span><br>';
    exit;
    }
...
elseif(strpos($result2, "stripe_3ds2_fingerprint")) {
    ...
    echo 'LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result:  3D ✅  Checker By: @TG_StinxBid </span><br>';
    exit;
    }
...
elseif(strpos($result2, 'Your card was declined.')) {
    ...
    echo 'DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: YOUR CARD WAS DECLINED ❌  </span><br>';
}
...
elseif(strpos($result2, '"cvc_check": "pass"')) {
    ...
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result:CVV LIVE ✅  Checker By: @TG_StinxBid </span><br>';
exit;
}

elseif(strpos($result2, "Membership Confirmation")) {

    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result: Membership Confirmation '.$amt.' ✅  Checker By: @TG_StinxBid /span><br>';
exit;
}
...
elseif(strpos($result2, "incorrect_cvc")) {
    ...
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result:CCN LIVE ✅  Checker By: @TG_StinxBid </span><br>';
exit;
}
