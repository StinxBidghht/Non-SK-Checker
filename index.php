		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>𝗡𝗼𝗻 𝗦𝗸 𝗖𝗵𝗲𝗰𝗸𝗲𝗿</strong></h4>
					<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://t.me/HaxMethod">𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗢𝗳𝗳𝗶𝗰𝗶𝗮𝗹 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 </a> <br>
					<textarea rows="6" class="form-control text-center form-checker mb-2" placeholder="PUT YOUR CC HERE :>"></textarea>
					
	<br>	
<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://t.me/TG_StinxBid">𝗦𝗮𝗻𝗱 𝗬𝗼𝘂𝗿 𝗙𝗲𝗲𝗱𝗯𝗮𝗰𝗸 </a> <br>		
...
Swal.fire({ title: "𝗦𝘁𝗶𝗻𝘅𝗕𝗶𝗱 𝗖𝗵𝗲𝗰𝗸𝗲𝗿", text: "𝗜𝘁𝘀 𝗖𝗵𝗲𝗰𝗸𝗲𝗿 𝗧𝗼𝘁𝗲𝗹𝗹𝘆 𝗙𝗿𝗲𝗲 𝗦𝗼 𝗗𝗼𝗻𝘁 𝗕𝘂𝘆 (𝗕𝗲 𝗔𝘄𝗮𝗿𝗲)", icon: "warning", confirmButtonText: "𝗢𝗸, 𝗧𝗵𝗮𝗻𝗸𝘀", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
